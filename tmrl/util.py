    ...
    try:
        ...
        try:
            ...
            if hasattr(dinov3, '__path__'): # It is a package
                # Map old class names to new Feature-based classes for compatibility/loading
                if hasattr(dinov3_policy, 'DinoV3FeatureActorCritic'):
                    dinov3.DinoV3ActorCritic = dinov3_policy.DinoV3FeatureActorCritic
                if hasattr(dinov3_policy, 'SquashedGaussianDinoV3FeatureActor'):
                    dinov3.SquashedGaussianDinoV3Actor = dinov3_policy.SquashedGaussianDinoV3FeatureActor
                if hasattr(dinov3_policy, 'DinoV3FeatureQFunction'):
                    dinov3.DinoV3QFunction = dinov3_policy.DinoV3FeatureQFunction
                # dinov3.DinoV3Encoder = dinov3_policy.DinoV3Encoder # Encoder is no longer in policy
        except ImportError:
            pass
